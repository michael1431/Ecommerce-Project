    ...
    <div class="container-12">
        ...
        <div class="row">
            ...
            <table class="table table-striped table-condensed table-bordered">
                                    <thead>
                                        <tr>
                                            <td colspan="2" class="text-center font-weight-bold">Customer Information</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><b><?php echo $result['phone'];?></b></td>           
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><b><?php echo $result['countryName'];?></b></td>
           
                                        </tr> 
                                        <tr>
                                            <td class="text-right"><b>City :</b></td>
                                            <td><b><?php echo $result['cityName'];?></b></td>           
                                        </tr>
                                        <tr>
                                            <td class="text-right"><b>Zip :</b></td>
                                            <td><b><?php echo $result['zip'];?></b></td>           
                                        </tr>
